...
public:
    ...
    [[nodiscard]] bool  hasFriendRoomVerification(UserID sender, UserID receiver) const;
    ...
    [[nodiscard]] bool  hasGroupRoomVerification(UserID sender, GroupID receiver) const;
